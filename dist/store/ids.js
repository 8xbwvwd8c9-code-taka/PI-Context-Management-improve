 ...
 */
export function projectIdFromSeed(seed) {
...
export function projectIdFromSeedFull(seed) {
    return `proj_${projectHashFull(seed)}`;
}
function projectHashShort(seed) {
    const full = projectHashFull(seed);
    return full.slice(0, 24);
}
function projectHashFull(seed) {
