 ...
 */
import { type ContextUsage, type PressureState } from "../core/pressure.js";
import { type ContextProfile } from "../core/profiles.js";
import { type RolloverDecision } from "../core/rollover-pressure.js";
...
export declare const LIVE_PRESSURE_HOOK_NAME = "picm-pressure-live";
/**
 ...
 * stays consistent.
 */
export declare function computeLivePressure(input: ComputeLivePressureInput): ComputeLivePressureOutput;
//# sourceMappingURL=pressure-live.d.ts.map