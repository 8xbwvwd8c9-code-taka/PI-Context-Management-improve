 ...
 */
export const PRESSURE_DIRECTIVE_DENY_SUBSTRINGS = [
    "<tool_result",
    "<tool_result>",
    "<bash",
    "<file_content",
 ...
 */
export function buildPressureRolloverMessage(decision) {
    return {
 ...
 */
export const PRESSURE_ROLLOVER_OPTIONS = {
    triggerTurn: true,
    deliverAs: "followUp",
};
/**
 ...
 */
export function buildPressureRolloverCall(decision) {
    return {
...
export class PressureTriggerMachine {
    ...
    constructor(projectId, sessionId, now = () => new Date().toISOString()) {
    ...
    shouldSendOnSettled(decision) {
        ...
        if (decision.action === "none")
            return false;
        if (decision.action === "checkpoint_refresh")
            return false;
 ...
 */
export function shouldTriggerPressureRollover(input) {
    ...
    if (decision.action !== "request_pressure_rollover" &&
...
//# sourceMappingURL=pressure-trigger.js.map